...
export function Hero() {
  ...
  {/* Logo */}
                      <div className="flex flex-col items-center gap-3 z-10">
                        {/* Logo - clean, no distortion */}
                                <motion.div
                                            ...
                                            >
                                  {/* Glow behind logo - usando box-shadow em vez de divs sobrepostas */}
                                            <div
                                                            className="absolute inset-0 pointer-events-none"
                                                            style={{
                                                                              background: "radial-gradient(ellipse at center, hsl(152 100% 50% / 0.3) 0%, transparent 70%)",
                                                                              filter: "blur(20px)",
                                                                              borderRadius: "50%",
                                                            }}
                                                          />
            ...
            className="relative w-[260px] sm:w-[340px] md:w-[420px] lg:w-[500px] h-[260px] sm:h-[340px] md:h-[420px] lg:h-[500px] object-contain"                                                            style={{ imageRendering: "auto" }}
                                                            style={{ imageRendering: "-webkit-optimize-contrast" }}                                </motion.div>motion.div>
                      </div>div>
